...
Grading submissions, showing grades, AI bot helper for post-exam review.
...
> The application will start immediately. Open your browser and navigate to `http://localhost:4200/`. _Note: If you want to test the serverless function locally, you can use `vercel dev` instead of `ng serve`._
...
**Anas Abdelhakim Ali**  
_Full Stack & AI Engineer | Senior CS Student at Nile University_
